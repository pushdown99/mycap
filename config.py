...
voc2007_train_opts = {
  'train':                    True,
  'imagenet':                 'vgg16',
#  'load_from':                'voc_vgg16_fasterrcnn_tf2_best.h5',
  'save_to':                  '',
...
nia0404_train_opts = {
  'train':                    True,
  'imagenet':                 'vgg16',
#  'load_from':                'nia_vgg16_fasterrcnn_tf2_best.h5',
  'save_to':                  '',
  'save_best_to':             'nia_vgg16_fasterrcnn_tf2_best_e10.h5',
...
#  'load_from':                'nia_vgg16_fasterrcnn_tf2_best.h5',
  'save_to':                  '',
  'save_best_to':             'coco_vgg16_fasterrcnn_tf2_best_e10.h5',
  'dataset_dir':              'datasets/COCO',
  'train_split':              'trainval',
  'eval_split':               'test',
  'cache_images':             '',
  'periodic_eval_samples':    100,
  'checkpoint_dir':           '',
  'plot':                     '',
  'log_csv':                  '',
  'epochs':                   10,
...
#  'load_from':                'nia_vgg16_fasterrcnn_tf2_best.h5',
  'save_to':                  '',
  'save_best_to':             'vg_vgg16_fasterrcnn_tf2_best_e10.h5',
  'dataset_dir':              'datasets/GENOME',
  'train_split':              'trainval',
  'eval_split':               'test',
  'cache_images':             '',
  'periodic_eval_samples':    100,
